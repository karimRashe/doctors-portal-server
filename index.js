...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.w3guwa9.mongodb.net/?retryWrites=true&w=majority`;
...
function sendAppointmentEmail(booking){
  ...
  const email ={
    ...
    html:`
       ...
       <h3>Your Appointment for ${treatment} is confiremd</h3>
...
function sendPaymentConfirmationEmail(booking){
  ...
  const email ={
    ...
    text:`Your payment forthis Appointment  ${treatment} is on${date} at ${slot} is Confirmed`,
    html:`
       <div>
       <p>Hello ${patientName},</p>
       <h3>Thank you for your payment. /h3>
       <h3>We have receivedyour payment </h3>
       <p>Looking forward to seeing you on ${date} at${slot}.</p>
       <h3>Our Address</h3>
       <p>feni rumpur</p>
       <p>Bangladesh</p>
